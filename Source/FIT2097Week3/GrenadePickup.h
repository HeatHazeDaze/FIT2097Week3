...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FGiveGrenadeEvent);

UCLASS()
class FIT2097WEEK3_API AGrenadePickup : public AActor, public IInteractable
{
	GENERATED_BODY()
...
public:	
	...
	//Event Dispatcher to call on the give grenade function in listeners.
	UPROPERTY(BlueprintAssignable, Category = "EventDispatchers")
		FGiveGrenadeEvent GiveGrenade;
