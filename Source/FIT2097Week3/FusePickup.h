...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FGiveFuseEvent);

UCLASS()
class FIT2097WEEK3_API AFusePickup : public AActor, public IInteractable
{
	GENERATED_BODY()
...
public:	
	...
	//Event Dispatcher to call on the give fuse function in listeners.
	UPROPERTY(BlueprintAssignable, Category = "EventDispatchers")
		FGiveFuseEvent GiveFuse;
